...
class CalcPage1 extends StatefulWidget {
  const CalcPage1({super.key});

  @override
  State<CalcPage1> createState() => _CalcPageState();
}

class _CalcPageState extends State<CalcPage1> {
  final _myBox = Hive.box('mybox');
  MarkDataBase1 db = MarkDataBase1();
  CourseDataBase dbCourse = CourseDataBase();
  GradesDataBase dbGrade = GradesDataBase();
  @override
  void initState() {
    if (_myBox.get("MARKCALC1") == null) {
      db.initialData();
    } else {
      db.loadData();
    }
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            dbCourse.courses.length < 5 ? dbCourse.courses[0] : 'Course 1',
