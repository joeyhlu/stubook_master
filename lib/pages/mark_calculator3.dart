...
class CalcPage3 extends StatefulWidget {
  const CalcPage3({super.key});

  @override
  State<CalcPage3> createState() => _CalcPageState();
}

class _CalcPageState extends State<CalcPage3> {
  final _myBox = Hive.box('mybox');
  MarkDataBase3 db = MarkDataBase3();
  CourseDataBase dbCourse = CourseDataBase();
  GradesDataBase dbGrade = GradesDataBase();
  @override
  void initState() {
    if (_myBox.get("MARKCALC3") == null) {
      db.initialData();
    } else {
      db.loadData();
    }
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            dbCourse.courses.length < 5 ? dbCourse.courses[2] : 'Course 3',
